...
exports.stylistLeaves = exports.stylistSchedules = exports.stylists = void 0;
...
exports.stylists = (0, mysql_core_1.mysqlTable)('stylists', {
    ...
    rating: (0, mysql_core_1.decimal)('rating', { precision: 3, scale: 2 }).notNull().default('0.00'),
...
exports.stylistSchedules = (0, mysql_core_1.mysqlTable)('stylist_schedules', {
    id: (0, mysql_core_1.varchar)('id', { length: 128 }).primaryKey().$defaultFn(() => (0, cuid2_1.createId)()),
    stylistId: (0, mysql_core_1.varchar)('stylist_id', { length: 128 }).notNull().references(() => exports.stylists.id),
